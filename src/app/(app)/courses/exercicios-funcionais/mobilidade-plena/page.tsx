...
import { lessons, type Lesson } from '@/lib/mobilidade-plena-lessons';
import { cn } from '@/lib/utils';

export default function MobilidadePlenaPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8 text-center">
        <h1 className="font-headline text-3xl font-bold tracking-tight">Mobilidade Plena</h1>
