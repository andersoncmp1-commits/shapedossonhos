...
import { lessons, type Lesson } from '@/lib/treino-para-gestantes-lessons';
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8 text-center">
        <h1 className="font-headline text-3xl font-bold tracking-tight">Treino para Gestantes</h1>
